#!/usr/bin/env python3
"""
Test checkout performance with real JWT from browser
"""
...
async def test_with_real_jwt():
    """Test with real JWT from browser"""
    
    print("🚀 AutoProof Checkout Performance Test (with real JWT)")
    print("="*60)
    
    # Get JWT from user
    print("Please paste your real JWT token from browser dev tools:")
    print("(Go to browser dev tools → Application → Local Storage → Clerk → __clerk_client_jwt)")
    jwt = input("JWT: ").strip()
...
if __name__ == "__main__":
    asyncio.run(test_with_real_jwt()) 