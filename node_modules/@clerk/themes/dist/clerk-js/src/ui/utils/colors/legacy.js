...
const hslaTupleToHslaColor = (hsla) => {
    var _a;
    return { h: hsla[0], s: hsla[1], l: hsla[2], a: (_a = hsla[3]) !== null && _a !== void 0 ? _a : 1 };
};
const hwbTupleToRgbTuple = (hwb) => {
    ...
    let wh = hwb[1] / 100;
    let bl = hwb[2] / 100;
    const a = (_a = hwb[3]) !== null && _a !== void 0 ? _a : 1;
    const ratio = wh + bl;
    let f;
    // Wh + bl cant be > 1
    if (ratio > 1) {
...
const rgbaTupleToHslaColor = (rgb) => {
    ...
    const g = rgb[1] / 255;
    const b = rgb[2] / 255;
    const a = (_a = rgb[3]) !== null && _a !== void 0 ? _a : 1;
...
const hslaColorToHslaString = ({ h, s, l, a }) => {
    return `hsla(${h}, ${s}%, ${l}%, ${a !== null && a !== void 0 ? a : 1})`;
};
const parse = (str) => {
    // First try to resolve CSS variables
    const resolvedStr = (0, cssVariables_1.resolveCSSVariable)(str);
...
const makeTransparent = (color, percentage = 0) => {
    ...
    const hsla = toHslaColor(color);
    return toHslaString(changeHslaAlpha(hsla, ((_a = hsla.a) !== null && _a !== void 0 ? _a : 1) * percentage));
};
...
const adjustForLightness = (color, lightness = 5) => {
    ...
    const hsla = exports.colors.toHslaColor(color);
    if (!hsla) {
        return color;
    }
    if (hsla.l === 100) {
    ...
    return exports.colors.toHslaString(hsla);
};
exports.colors = {
    toHslaColor,
    toHslaString,
