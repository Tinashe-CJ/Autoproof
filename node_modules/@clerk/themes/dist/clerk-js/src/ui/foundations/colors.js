...
exports.colors = Object.freeze({
    ...
    ...(0, scales_1.colorOptionToThemedAlphaScale)('#2F3037', 'primaryAlpha'),
    danger50: '#FEF2F2',
    danger100: '#FEE5E5',
    danger200: '#FECACA',
    danger300: '#FCA5A5',
    ...
    danger950: '#450A0A',
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    ...(0, scales_1.colorOptionToThemedAlphaScale)('#EF4444', 'dangerAlpha'),
    warning50: '#FFF6ED',
    warning100: '#FFEBD5',
    warning200: '#FED1AA',
    warning300: '#FDB674',
    ...
    warning950: '#431207',
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    ...(0, scales_1.colorOptionToThemedAlphaScale)('#F36B16', 'warningAlpha'),
    success50: '#F0FDF2',
    success100: '#DCFCE2',
    success200: '#BBF7C6',
    success300: '#86EF9B',
    ...
    success950: '#052E0F',
    // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
    ...(0, scales_1.colorOptionToThemedAlphaScale)('#22C543', 'successAlpha'),
});
