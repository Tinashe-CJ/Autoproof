...
export const stripeProducts: StripeProduct[] = [
  ...
  },
  {
    ...
    name: 'Growth',
    description: 'For growing teams with increasing compliance needs and advanced features',
    mode: 'subscription',
    price: 75.00,
    currency: 'usd',
    interval: 'month'
  },
  {
    ...
    name: 'Business',
    description: 'For organizations with complex compliance requirements and enterprise features',
    mode: 'subscription',
    price: 300.00,
    currency: 'usd',
    interval: 'month'
